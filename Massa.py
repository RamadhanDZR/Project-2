...
with st.sidebar.container():
    ...
    lottie_hello = load_lottieurl("https://lottie.host/a53d6f60-9cdc-410e-aadb-3dfe47d86149/P3KG9ijizD.json")
...
if selected_option == "Kalkulator":
    ...
    if selected_option == "Kalkulator":
        ...
        def parse_formula(formula):
            ...
            for (element, count) in matches:
                ...
                if element in senyawa_dict:
                    senyawa_dict[element] += count
                else:
                    senyawa_dict[element] = count
            return senyawa_dict
    ...
    if selected_option == "Contoh Soal":
        ...
        st.write ("Berapakah massa unsur Sulfur yang terdapat pada 0,344 gram senyawa barium sulfat jika diketahui Ar sulfur adalah 32 dan Mr barium sulfat adalah 233.")
        st.image ("Soal2.jpeg")
